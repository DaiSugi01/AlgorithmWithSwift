...
//import Foundation
//
//func sushi(filePathForInput: String) {
//
//  func sushiReviews() {
//    let contents = try! String(contentsOfFile: filePathForInput, encoding: .utf8)
//    var lines = contents.split(separator: "\n")
//    let numOfSets = lines[0].split(separator: " ")
//    let numOfRestaurants = Int(numOfSets[0])!
//    let realSushiList = lines[1].split(separator: " ")
//
...
//          if let peek = peek {
//            if visited[peek] && !hasChildRealSushi[peek] {
//              hasChildRealSushi[peek] = true
//            }
//          }
//        }
//      }
